...
3. 각 씬마다 다음 정보를 포함:
   - 대본 (script): 아바타가 말할 내용
     * ⚠️ **CRITICAL: 반드시 35-45자 이내 (공백 제외, 한국어 기준)**
     * ⚠️ **45자 초과 시 생성 실패로 간주됩니다**
     * **문장 수 제한: 최대 1-2문장만 사용**
     * **예상 시간: 7-8초 분량 (초당 5-6자 기준)**
     * **필수 원칙**:
       - 인사말/자기소개는 극도로 간결하게 또는 생략
       - 핵심 주제만 1-2문장으로 압축
       - "그래서", "또한", "따라서" 등 연결어 최소화
       - 구체적 수치나 고유명사보다 핵심 개념 중심
     * ✅ 좋은 예시들:
       - "바이브 코딩 v2는 컨텍스트 엔지니어링입니다." (24자)
       - "코딩의 맥도날드화 시대가 왔습니다." (19자)
       - "v1.0은 코드 중심 협업을 시작했습니다." (21자)
     * ❌ 나쁜 예시들:
       - "안녕하세요. 오늘은 코딩의 맥도날드화에 대해 이야기하겠습니다." (32자, 하지만 인사말 불필요)
       - "그래서 v1.0에서는 팀 전체가 바이브 코딩을 하는 시대로 전환했습니다..." (35자+, 연결어 과다)
